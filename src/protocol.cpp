...
#pragma optimize("", off)
	...
	void protocol::setup()
	{
		...
		const BYTE receive_pattern_byte[] = {
			0x55, 0x8B, 0xEC, 0x83, 0xC4, 0xFF, 0x53, 0x56, 0x57, 0x33, 0xC9, 0x89, 0x4D, 0xF4, 0x89, 0x4D,
			0xF0, 0x89, 0x55, 0xFC, 0x8B, 0xD8, 0x8B, 0x45, 0xFC
		};
		const auto receive_pattern_mask = "xxxxx?xxxxxxxxxxxxxxxxxxx";
